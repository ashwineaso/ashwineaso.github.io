...
n.byteLength=function(e){return 3*e.length/4-s(e)},n.toByteArray=function(e){var t,n,r,a,l,u=e.length
a=s(e),l=new o(3*u/4-a),n=a>0?u-4:u
var c=0
...
return 2===a?(r=i[e.charCodeAt(t)]<<2|i[e.charCodeAt(t+1)]>>4,l[c++]=255&r):1===a&&(r=i[e.charCodeAt(t)]<<10|i[e.charCodeAt(t+1)]<<4|i[e.charCodeAt(t+2)]>>2,l[c++]=r>>8&255,l[c++]=255&r),l},n.fromByteArray=function(e){for(var t,n=e.length,i=n%3,o="",a=[],l=16383,s=0,c=n-i;s<c;s+=l)a.push(u(e,s,s+l>c?c:s+l))
...
return"="===e[t-2]?2:"="===e[t-1]?1:0}function u(e,t,n){for(var i,o,a=[],l=t;l<n;l+=3)i=(e[l]<<16)+(e[l+1]<<8)+e[l+2],a.push(r[(o=i)>>18&63]+r[o>>12&63]+r[o>>6&63]+r[63&o])
...
//# sourceMappingURL=simplemde-8f638be9b49c6c5fc95902d6e470c1a3.map